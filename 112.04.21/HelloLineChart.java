...
public class HelloLineChart {

  public HelloLineChart(String appTitle) {
    JFrame f = new JFrame("HelloLineChart");
  ...
  private CategoryDataset createDataset() {
    ...
    dataset.addValue(20, "美國", "2005");
    dataset.addValue(20, "中國", "2010");
    dataset.addValue(25, "日本", "2010");
    dataset.addValue(30, "美國", "2010");
    dataset.addValue(15, "中國", "2015");
    dataset.addValue(40, "日本", "2015");
    dataset.addValue(30, "美國", "2015");
    return dataset;
  }
  public static void main(String[] args) throws Exception {
    HelloLineChart example =
    new HelloLineChart("HelloLineChart");
  }
}